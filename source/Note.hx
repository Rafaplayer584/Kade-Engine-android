...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inCharter:Bool = false, ?noteSkin:String = 'normal', ?glitched:Bool = false)
	{
		super();
		...
		else
		{
			...
			switch (noteTypeCheck)
			{
				...
				default:
					if (glitched)
						frames = Paths.getSparrowAtlas('notes/' + noteSkin + 'op', 'shared');
					else
